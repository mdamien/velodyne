...
|
|-----------------------------------------------------------------------------
| $Author: vissj $    $Date: 2011-12-15 12:20:48 +0100 (Do, 15 Dez 2011) $   $Revision: 14101 $
| $Id: vxlapi.h 14101 2011-12-15 11:20:48Z vissj $
|-----------------------------------------------------------------------------
...
#define XL_TRANSCEIVER_TYPE_PB_CAN_1051_CAP_FIX  0x013C //!< TJA1051 - fixed transceiver on e.g. 16xx/8970
...
#define XL_LIN_UNDEFINED_DLC                    (unsigned char) 0xff //!< set the DLC to undefined (xlLINSetDLC)
...
#define XL_MOST150_ECL_SEQ_DURATION_MIN                  1      // -> 100 탎
...
#define XL_MOST150_ECL_GLITCH_FILTER_MIN                 50      // -> 50 탎
 ...
 *  \param sourceMask                 [IN] each bit stands for an event source and can separately be set. 
 *                                         Use the definitions of the sourcemask (see XL_MOST150_SOURCE_...).
 *  \return XLstatus                       general status information
 */
 ...
 *  \param  bufferType                [IN] Bitmask for receive buffer type (control messages and/or packets (MDP/MEP)).
 ...
 *                                         number of bytes stored and the function returs an error (XL_ERR_QUEUE_IS_FULL).
 *  \return XLstatus                       general status information 
 */
 ...
 *  \param  pEclStatesDuration        [IN] Pointer to a buffer containing the ECL sequence states duration in multiple of 100 탎 (max. value XL_MOST150_ECL_SEQ_DURATION_MAX)
 ...
 *  \param  XLuserHandle userHandle:  [IN] used to match the response of the driver to the requests of the application
 *                                         if an event is received spontaneously
 *  \param  duration                  [IN] Duration (in 탎) of glitches to be filtered. Value range: 50 탎 .. 50 ms (Default: 1 ms)
 *  \return XLstatus                       general status information
 */
