...
private:	
	...
	struct s_SensorsData		sensorsData_;		//	Données des capteurs
	matrice						X_;					//	Matrice d'état du filtre de kalman
	matrice						Y_;					//	Matrice de mesure GPS
	matrice						P_;					//	Matrice de covariance de l'erreur
	matrice						U_;					//	Matrice d'entrée
	matrice						Qgamma_;			//	Matrice du bruit d'entrée
	matrice						Qalpha_;			//	Matrice du bruit du modèle
