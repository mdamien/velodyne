/*==========================================================  (-*- C++ -*-)
 *
 * @file CBFormPoint3D.h
 * 
 * @version  $Id: CBFormPoint3D.h,v 1.21 2006/05/03 17:45:26 dlabrousse Exp $ 
 * 
...
#ifndef __CBFORMPOINT3D_H__
#define __CBFORMPOINT3D_H__

/*!
  @file CBFormPoint3D.h
	CBFormPoint3D class definition.
*/
 ...
 * @class CBFormPoint3D
 *
 * @brief This class defines a SVS 3D form of geometric type #EB_GEOTYPE_POINT.
 *
 * CBFormPoint3D is a class that defines a SVS 3D form of geometric type #EB_GEOTYPE_POINT.
 * This class handles form's geometry.
 *
 */
class BSVS_EXPORT CBFormPoint3D : public CBForm
{
 private:
  ...
  TB_3D_LONGPOINT * mGeo;           //!< Form's geometry = array of #TB_3D_LONGPOINT
 ...
 public:
  ...
  /**
   * Constructs a CBFormPoint3D from a #TB_EXTERN_OBJECT object (see BTypes.h).
   ...
   */
  CBFormPoint3D(const TB_EXTERN_OBJECT& inObject,
								TB_LONGRECT           & outRect);

  /**
   * \internal
   * Constructs a CBFormPoint3D by reading data from a SVS stream.
   * @param inBitStream SVS stream to read from
   * @param inObjectMgr Form's object manager
   * @param outRect     Form's bounding rectangle
   */
  CBFormPoint3D(CBBitStream        * inBitStream,
   ...
   * Destructor.
   */
  virtual ~CBFormPoint3D(void);

  /**
   * Copies form into a new CBFormPoint3D and returns new form.
  ...
  static TB_3D_LONGPOINT * ReadGeoFromStream(CBBitStream        * inBitStream,
                                             const CBTreeParser * inTreeParser,
																						 TBuint16             inNbForm);
...
protected:
   ...
   * @param inCopyAttributes If \c false, attributes will not be copied (only geometry)
   */
  CBFormPoint3D(const CBFormPoint3D& inSource,
								TBbool               inCopyAttributes = true);
  /**
   * Assigment operator
   * @param inSource Source form
   */
  CBFormPoint3D & operator=(const CBFormPoint3D& inSource);
  ...
  static void ReadPoint(CBBitStream          * inBitStream,
												...
												TB_3D_LONGPOINT      & outPoint);
};

#endif //  __CBFORMPOINT3D_H__
