...
#ifndef _SerialCOM_Msg_RXM_RAW_Ublox_H
#define _SerialCOM_Msg_RXM_RAW_Ublox_H
...
/*! \class SerialCOM_Msg_RXM_RAW
 *	\brief Allows to handle RXM-RAW messages coming from a Ublox GPS receiver
 ...
 *	\warning None
 *	
 *  Can identify an incoming message as a RXM-RAW message and extract information from\n
 ...
 */
	...
	class SerialCOM_Msg_RXM_RAW : public SerialCOM_Msg , public structRXM_RAW
	{

	public : 

		/*! \brief Constructor. Intitialise the member variables*/
		SerialCOM_Msg_RXM_RAW();
		...
		//! return the size of the structure structRXM_RAW
		int getSizeOfStruct(){return sizeof(structRXM_RAW);};
