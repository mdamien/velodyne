#ifndef _SerialCOM_Msg_NAV_POSUTM_Ublox_H
#define _SerialCOM_Msg_NAV_POSUTM_Ublox_H
...
/*! \class SerialCOM_Msg_NAV_POSUTM
 *	\brief Allows to handle NAV-POSUTM messages coming from a Ublox GPS receiver
 ...
 *	\warning None
 *	
 *  Can identify an incoming message as a NAV-POSUTM message and extract information from\n
 ...
 */
	...
	class SerialCOM_Msg_NAV_POSUTM: public SerialCOM_Msg, public structNAV_POSUTM
	{
	public:

		SerialCOM_Msg_NAV_POSUTM(void);
		...
		//! return the size of the structure structNAV_POSUTM
		int getSizeOfStruct(){return sizeof(structNAV_POSUTM);};
