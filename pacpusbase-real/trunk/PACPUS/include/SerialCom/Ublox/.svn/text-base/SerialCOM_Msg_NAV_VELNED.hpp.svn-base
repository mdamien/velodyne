#ifndef _SerialCOM_Msg_NAV_VELNED_Ublox_H
#define _SerialCOM_Msg_NAV_VELNED_Ublox_H
...
/*! \class SerialCOM_Msg_NAV_VELNED
 *	\brief Allows to handle NAV-VELNED messages coming from a Ublox GPS receiver
 ...
 *	\warning None
 *	
 *  Can identify an incoming message as a NAV-VELNED message and extract information from\n
 ...
 */
	...
	class SerialCOM_Msg_NAV_VELNED: public SerialCOM_Msg, public structNAV_VELNED
	{
	public:

		SerialCOM_Msg_NAV_VELNED(void);
		...
		//! return the size of the structure structNAV_VELNED
		int getSizeOfStruct(){return sizeof(structNAV_VELNED);};
