#ifndef _SerialCOM_Msg_NAV_SVINFO_Ublox_H
#define _SerialCOM_Msg_NAV_SVINFO_Ublox_H
...
/*! \class SerialCOM_Msg_NAV_SVINFO
 *	\brief Allows to handle NAV-SVINFO messages coming from a Ublox GPS receiver
 ...
 *	\warning None
 *	
 *  Can identify an incoming message as a NAV-SVINFO message and extract information from\n
 ...
 */
	...
	class SerialCOM_Msg_NAV_SVINFO: public SerialCOM_Msg, public structNAV_SVINFO
	{

	public:

		SerialCOM_Msg_NAV_SVINFO(void);
		...
		//! return the size of the structure structNAV_SVINFO
		int getSizeOfStruct(){return sizeof(structNAV_SVINFO);};
