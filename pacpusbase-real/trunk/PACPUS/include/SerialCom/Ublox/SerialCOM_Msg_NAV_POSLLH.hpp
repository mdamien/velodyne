#ifndef _SerialCOM_Msg_NAV_POSLLH_Ublox_H
#define _SerialCOM_Msg_NAV_POSLLH_Ublox_H
...
namespace Ublox{
/*! \class SerialCOM_Msg_NAV_POSLLH
 *	\brief Allows to handle NAV-POSLLH messages coming from a Ublox GPS receiver
 ...
 *	\warning None
 *	
 *  Can identify an incoming message as a NAV-POSLLH message and extract information from\n
 ...
 */
	...
	class SerialCOM_Msg_NAV_POSLLH: public SerialCOM_Msg, public structNAV_POSLLH
	{
	public:

		SerialCOM_Msg_NAV_POSLLH(void);
		...
		//! return the size of the structure structNAV_POSLLH
		int getSizeOfStruct(){return sizeof(structNAV_POSLLH);};
