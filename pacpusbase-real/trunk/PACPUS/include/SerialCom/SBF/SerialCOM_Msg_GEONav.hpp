/*!
\class SerialCOM_Msg_GEONav
\brief Decoded navigation data for SBAS SV
\author C. Fouque
\version 1.0
\date Dec. 2008
\bug None
...
This block contains the decoded navigation data transmitted in SBAS message type 9. Refer to section A.4.4.11 of DO 229 [2] for further details.

<b>Output rate:</b> if enabled, this block is generated at least each time MT09 is received from an SBAS satellite. Additionally, each time the Nav category is specified in the SetSBFOutput command, all the ephemeris parameters currently available in the receiver are output.
...
#ifndef _SerialCOM_Msg_GEONav_Plrx_H
#define _SerialCOM_Msg_GEONav_Plrx_H
...
namespace Plrx
{
   ...
   class SerialCOM_Msg_GEONav : public SerialCOM_Msg , public SbfDataGEONav
   {

      public :

         /*! \brief Constructor. Intitialise the member variables*/
         SerialCOM_Msg_GEONav();
	...
	//! return the size of the structure SbfDataGEONav
         int getSizeOfStruct(){return sizeof(SbfDataGEONav);};
