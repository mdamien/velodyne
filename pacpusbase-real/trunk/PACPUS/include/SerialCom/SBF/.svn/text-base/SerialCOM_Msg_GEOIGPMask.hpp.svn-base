/*!
\class SerialCOM_Msg_GEOIGPMask
\brief Decoded Ionospheric grid point mask
\author C. Fouque
\version 1.0
\date Dec. 2008
\bug None
...
This block contains the decoded ionospheric grid point mask transmitted in SBAS message type 18. Refer to section A.4.4.9 of DO 229 [2] for further details.

<b>Output rate:</b> if enabled, this block is generated each time MT18 is received from an SBAS satellite.
...
#ifndef _SerialCOM_Msg_GEOIGPMask_Plrx_H
#define _SerialCOM_Msg_GEOIGPMask_Plrx_H
...
namespace Plrx
{
   ...
   class SerialCOM_Msg_GEOIGPMask : public SerialCOM_Msg , public SbfDataGEOIGPMask
   {

      public :

         /*! \brief Constructor. Intitialise the member variables*/
         SerialCOM_Msg_GEOIGPMask();
	...
	//! return the size of the structure SbfDataGEOIGPMask
         int getSizeOfStruct(){return sizeof(SbfDataGEOIGPMask);};
