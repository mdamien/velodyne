/*!
\class SerialCOM_Msg_GEODegrFactors
\brief SBAS Decoded degradation factors
\author C. Fouque
\version 1.0
\date Dec. 2008
\bug None
...
This block contains the decoded degradation factors transmitted in SBAS message type 10. Refer to section A.4.5 of DO 229 [2] for further details.

<b>Output rate:</b> if enabled, this block is generated each time MT10 is received from an SBAS satellite.
...
#ifndef _SerialCOM_Msg_GEODegrFactors_Plrx_H
#define _SerialCOM_Msg_GEODegrFactors_Plrx_H
...
namespace Plrx
{
   ...
   class SerialCOM_Msg_GEODegrFactors : public SerialCOM_Msg , public SbfDataGEODegrFactors
   {

      public :

         /*! \brief Constructor. Intitialise the member variables*/
         SerialCOM_Msg_GEODegrFactors();
	...
	//! return the size of the structure SbfDataGEODegrFactors
         int getSizeOfStruct(){return sizeof(SbfDataGEODegrFactors);};
