/*!
\class SerialCOM_Msg_GEOServiceLevel
\brief Decoded Service Level message
\author C. Fouque
\version 1.0
\date Dec. 2008
\bug None
...
This block contains a decoded service level message for a geostationary SBAS satellite as sent in message type 27. Refer to section A.4.4.13 of DO 229 [2] for further details.

<b>Output rate:</b> if enabled, this block is generated each time MT27 is received from an SBAS satellite.
.
...
#ifndef _SerialCOM_Msg_GEOServiceLevel_Plrx_H
#define _SerialCOM_Msg_GEOServiceLevel_Plrx_H
...
namespace Plrx
{
   ...
   class SerialCOM_Msg_GEOServiceLevel : public SerialCOM_Msg , public SbfDataGEOServiceLevel
   {

      public :

         /*! \brief Constructor. Intitialise the member variables*/
         SerialCOM_Msg_GEOServiceLevel();
	...
	//! return the size of the structure SbfDataGEOServiceLevel
         int getSizeOfStruct(){return sizeof(SbfDataGEOServiceLevel);};
