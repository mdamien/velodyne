/*!
\class SerialCOM_Msg_GEOLongTermCorr
\brief decoded long term corrections
\author C. Fouque
\version 1.0
\date Dec 2008
\bug None
...
This block contains the decoded long term corrections transmitted in SBAS message types 24 and 25. Refer to section A.4.4.7 and A.4.4.8 of DO 229 [2] for further details.

<b>Output rate:</b> if enabled, this block is generated each time MT24 or MT25 is received from an SBAS satellite.
...
#ifndef _SerialCOM_Msg_GEOLongTermCorr_Plrx_H
#define _SerialCOM_Msg_GEOLongTermCorr_Plrx_H
...
namespace Plrx
{
   ...
   class SerialCOM_Msg_GEOLongTermCorr : public SerialCOM_Msg , public SbfDataGEOLongTermCorr
   {

      public :

         /*! \brief Constructor. Intitialise the member variables*/
         SerialCOM_Msg_GEOLongTermCorr();
	...
	//! return the size of the structure SbfDataGEOLongTermCorr
         int getSizeOfStruct(){return sizeof(SbfDataGEOLongTermCorr);};
