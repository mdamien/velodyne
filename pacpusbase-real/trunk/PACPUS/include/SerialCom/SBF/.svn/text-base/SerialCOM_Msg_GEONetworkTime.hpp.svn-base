/*!
\class SerialCOM_Msg_GEONetworkTime
\brief SBAS network time offset
\author C. Fouque
\version 1.0
\date Dec 2008
\bug None
...
This block contains the decoded network time offset parameters transmitted in SBAS message type 12. Refer to section A.4.4.15 of DO 229 [2] for further details.

<b>Output rate:</b> if enabled, this block is generated each time MT12 is received from an SBAS satellite.
...
#ifndef _SerialCOM_Msg_GEONetworkTime_Plrx_H
#define _SerialCOM_Msg_GEONetworkTime_Plrx_H
...
namespace Plrx
{
   ...
   class SerialCOM_Msg_GEONetworkTime : public SerialCOM_Msg , public SbfDataGEONetworkTime
   {

      public :

         /*! \brief Constructor. Intitialise the member variables*/
         SerialCOM_Msg_GEONetworkTime();
	...
	//! return the size of the structure SbfDataGEONetworkTime
         int getSizeOfStruct(){return sizeof(SbfDataGEONetworkTime);};
