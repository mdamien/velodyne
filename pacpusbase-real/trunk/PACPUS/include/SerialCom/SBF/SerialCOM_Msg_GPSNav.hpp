/*!
\class SerialCOM_Msg_GPSNav
\brief GPS ephemeris and clock (decoded)
...
The GPSNav block contains the decoded navigation data for one GPS satellite. These data are
conveyed in subframes 1 to 3 of the satellite navigation message. Refer to GPS ICD [3] for further
details.
...
#ifndef _SerialCOM_Msg_GPSNav_Plrx_H
#define _SerialCOM_Msg_GPSNav_Plrx_H
...
namespace Plrx
{
   ...
   class SerialCOM_Msg_GPSNav : public SerialCOM_Msg , public SbfDataGPSNav
   {

      public :

         /*! \brief Constructor. Intitialise the member variables*/
         SerialCOM_Msg_GPSNav();
	...
	//! return the size of the structure SbfDataGPSNav
         int getSizeOfStruct(){return sizeof(SbfDataGPSNav);};
