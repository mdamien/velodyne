/*!
\class SerialCOM_Msg_GPSIon
\brief Ionosphere data from the GPS subframe 5
...
The GPSIon block contains the decoded ionosphere data (the Klobuchar coefficients). These data are
conveyed in subframes 4, page 18 of the satellite navigation message. Refer to GPS ICD [3] for
further details.
...
#ifndef _SerialCOM_Msg_GPSIon_Plrx_H
#define _SerialCOM_Msg_GPSIon_Plrx_H
...
namespace Plrx
{
   ...
   class SerialCOM_Msg_GPSIon : public SerialCOM_Msg , public SbfDataGPSIon
   {

      public :

         /*! \brief Constructor. Intitialise the member variables*/
         SerialCOM_Msg_GPSIon();
	...
	//! return the size of the structure structMeasEpoch
         int getSizeOfStruct(){return sizeof(SbfDataGPSIon);};
