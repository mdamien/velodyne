/*!
\class SerialCOM_Msg_GEOFastCorrDegr
\brief SBAS Fast Correction Degradation factor
\author C. Fouque
\version 1.0
\date Dec. 2008
\bug None
...
This block contains the decoded fast correction degradation factors transmitted in SBAS message type 7. Refer to section A.4.4.5 of DO 229 [2] for further details.

<b>Output rate:</b> if enabled, this block is generated each time MT07 is received from an SBAS satellite.
...
#ifndef _SerialCOM_Msg_GEOFastCorrDegr_Plrx_H
#define _SerialCOM_Msg_GEOFastCorrDegr_Plrx_H
...
namespace Plrx
{
   ...
   class SerialCOM_Msg_GEOFastCorrDegr : public SerialCOM_Msg , public SbfDataGEOFastCorrDegr
   {

      public :

         /*! \brief Constructor. Intitialise the member variables*/
         SerialCOM_Msg_GEOFastCorrDegr();
	...
	//! return the size of the structure SbfDataGEOFastCorrDegr
         int getSizeOfStruct(){return sizeof(SbfDataGEOFastCorrDegr);};
