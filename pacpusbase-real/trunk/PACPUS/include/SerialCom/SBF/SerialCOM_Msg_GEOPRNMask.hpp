/*!
\class SerialCOM_Msg_GEOPRNMask
\brief PRN Mask transmitted by SBAS system
\author C. Fouque
\version 1.0
\date Dec. 2008
\bug None
...
This block contains the decoded PRN mask transmitted in SBAS message type 1. Refer to section A.4.4.2 of DO 229 [2] for further details.

<b>Output rate:</b> if enabled, this block is generated each time MT01 is received from an SBAS satellite.
...
#ifndef _SerialCOM_Msg_GEOPRNMask_Plrx_H
#define _SerialCOM_Msg_GEOPRNMask_Plrx_H
...
namespace Plrx
{
   ...
   class SerialCOM_Msg_GEOPRNMask : public SerialCOM_Msg , public SbfDataGEOPRNMask
   {

      public :

         /*! \brief Constructor. Intitialise the member variables*/
         SerialCOM_Msg_GEOPRNMask();
	...
	//! return the size of the structure SbfDataGEOPRNMask
         int getSizeOfStruct(){return sizeof(SbfDataGEOPRNMask);};
