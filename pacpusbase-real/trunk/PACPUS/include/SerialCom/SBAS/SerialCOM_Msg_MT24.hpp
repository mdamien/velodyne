#ifndef _SerialCOM_Msg_MT24_Ublox_H
#define _SerialCOM_Msg_MT24_Ublox_H
...
/*! \class SerialCOM_Msg_MT24
 *	\brief Allows to handle MT24 messages from SBAS
 ...
 *	\warning None
 *	
 *  Can identify an incoming message as a MT24 message and extract information from\n
 **/

	class SerialCOM_Msg_MT24: public SerialCOM_Msg, public SBAS::structMixedFastCorrectionLongTermError
	{

	public:

		SerialCOM_Msg_MT24(void);
