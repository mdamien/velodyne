#ifndef _SerialCOM_Msg_MT7_Ublox_H
#define _SerialCOM_Msg_MT7_Ublox_H
...
/*! \class SerialCOM_Msg_MT7
 *	\brief Allows to handle MT7 messages from SBAS
 ...
 *	\warning None
 *	
 *  Can identify an incoming message as a MT7 message and extract information from\n
 **/

	class SerialCOM_Msg_MT7: public SerialCOM_Msg, public SBAS::structFastCorrectionDegradationFactor
	{

	public:

		SerialCOM_Msg_MT7(void);
