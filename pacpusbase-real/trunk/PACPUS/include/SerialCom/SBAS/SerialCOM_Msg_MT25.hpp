#ifndef _SerialCOM_Msg_MT25_Ublox_H
#define _SerialCOM_Msg_MT25_Ublox_H
...
/*! \class SerialCOM_Msg_MT25
 *	\brief Allows to handle MT25 messages from SBAS
 ...
 *	\warning None
 *	
 *  Can identify an incoming message as a MT25 message and extract information from\n
 **/

	class SerialCOM_Msg_MT25: public SerialCOM_Msg, public SBAS::structLongTermSatelliteErrorCorrections
	{

	public:

		SerialCOM_Msg_MT25(void);
